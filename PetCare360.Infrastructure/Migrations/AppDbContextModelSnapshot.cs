...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetCare360.Domain.Entities.Clinica", b =>
                {
            ...
            modelBuilder.Entity("PetCare360.Domain.Entities.Consulta", b =>
                {
            ...
            modelBuilder.Entity("PetCare360.Domain.Entities.Medicamento", b =>
                {
            ...
            modelBuilder.Entity("PetCare360.Domain.Entities.Pet", b =>
                {
                    b.Property<int>("IdPet")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)")
            ...
            modelBuilder.Entity("PetCare360.Domain.Entities.Tutor", b =>
                {
                    b.Property<int>("IdTutor")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)")
            ...
            modelBuilder.Entity("PetCare360.Domain.Entities.Consulta", b =>
                {
                    b.HasOne("PetCare360.Domain.Entities.Clinica", "Clinica")
                        .WithMany("Consultas")
                        .HasForeignKey("IdClinica")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PetCare360.Domain.Entities.Pet", "Pet")
                        .WithMany("Consultas")
                        .HasForeignKey("IdPet")
            ...
            modelBuilder.Entity("PetCare360.Domain.Entities.Medicamento", b =>
                {
                    b.HasOne("PetCare360.Domain.Entities.Consulta", "Consulta")
            ...
            modelBuilder.Entity("PetCare360.Domain.Entities.Pet", b =>
                {
                    b.HasOne("PetCare360.Domain.Entities.Tutor", "Tutor")
                        .WithMany("Pets")
